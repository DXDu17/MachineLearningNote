...
<div align=center><img src="./images/SVM/Def_63.png" width="703" height="138"/></div>

对以上式子进行遍历。

由于将gi(w)拆为两个部分，所以在上面这个公式当中，这两个部分前面的系数分别用αi和βi来表达。

因此上一节中gi(w)前面的系数αi，在这里也被拆成了αi和βi。
